package com.joaquimley.transporteta.domain.usecase.bufferoo
...
import com.joaquimley.transporteta.domain.interactor.browse.GetBufferoos
...
class GetBufferoosTest {
    ...
    private lateinit var mockBufferooRepository: TransportRepository
