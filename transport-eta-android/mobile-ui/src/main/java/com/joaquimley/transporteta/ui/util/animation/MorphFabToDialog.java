...
package com.joaquimley.transporteta.ui.util.animation;
...
public class MorphFabToDialog extends ChangeBounds {
	...
	public void captureStartValues(TransitionValues transitionValues) {
		...
		transitionValues.values.put(PROPERTY_COLOR, fetchAccentColor(view.getContext()));
	...
	public void captureEndValues(TransitionValues transitionValues) {
		...
		transitionValues.values.put(PROPERTY_CORNER_RADIUS, view.getResources().getDimensionPixelSize(R.dimen.default_dialog_corners));
	}
